...
// src/app/features/movimientos/movimientos-cortes.component.ts
var _forTrack0 = ($index, $item) => $item.valor;
var _forTrack1 = ($index, $item) => $item.id;
function MovimientosCortesComponent_For_16_Template(rf, ctx) {
  if (rf & 1) {
...
function MovimientosCortesComponent_Conditional_17_For_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 8);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function MovimientosCortesComponent_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function MovimientosCortesComponent_Conditional_17_Template_select_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r2);
    ...
    \u0275\u0275text(5, "Todas");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(6, MovimientosCortesComponent_Conditional_17_For_7_Template, 2, 2, "option", 8, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function MovimientosCortesComponent_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
...
function MovimientosCortesComponent_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function MovimientosCortesComponent_Conditional_21_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
...
function MovimientosCortesComponent_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13)(1, "p", 18);
    \u0275\u0275text(2, "No hay causas de corte");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p", 19);
    \u0275\u0275text(4, " Aparecer\xE1n ac\xE1 cuando llegue un reporte de movimientos con las hojas de Corte Suprema o Corte de Apelaciones. ");
    \u0275\u0275elementEnd()();
  }
}
function MovimientosCortesComponent_Conditional_23_For_24_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(c_r6.rol || "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(c_r6.era || "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.fecha(c_r6.fecha_ingreso));
    \u0275\u0275advance();
    \u0275\u0275property("title", c_r6.caratulado || "");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", c_r6.caratulado || "-", " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(c_r6.estado_causa || "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(c_r6.institucion || "-");
    \u0275\u0275advance();
    \u0275\u0275property("title", c_r6.corte || "");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", c_r6.corte || "-", " ");
    \u0275\u0275advance(2);
...
function MovimientosCortesComponent_Conditional_23_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function MovimientosCortesComponent_Conditional_23_Conditional_25_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function MovimientosCortesComponent_Conditional_23_Conditional_25_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.irA(ctx_r2.pagina() + 1));
    });
...
function MovimientosCortesComponent_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "th");
    \u0275\u0275text(9, "FechaIngreso");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "th");
    \u0275\u0275text(11, "Caratulado");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "th");
    \u0275\u0275text(13, "EstadoCausa");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "th");
    \u0275\u0275text(15, "Instituci\xF3n");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(21, "FechaUbicaci\xF3n");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(22, "tbody");
    \u0275\u0275repeaterCreate(23, MovimientosCortesComponent_Conditional_23_For_24_Template, 19, 11, "tr", null, _forTrack1);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(25, MovimientosCortesComponent_Conditional_23_Conditional_25_Template, 8, 4, "div", 22);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(23);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.totalPaginas() > 1 ? 25 : -1);
  }
}
var MovimientosCortesComponent = class _MovimientosCortesComponent {
  ...
  static \u0275fac = function MovimientosCortesComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MovimientosCortesComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MovimientosCortesComponent, selectors: [["app-movimientos-cortes"]], viewQuery: function MovimientosCortesComponent_Query(rf, ctx) {
    if (rf & 1) {
  ...
  }, decls: 24, vars: 7, consts: [[1, "space-y-6"], [1, "text-2xl", "font-bold", "text-neutral-800"], [1, "text-neutral-500", "mt-1"], [3, "aplicar", "limpiar", "quitar", "chips"], ["for", "mc-busqueda", 1, "form-label"], ["id", "mc-busqueda", "type", "text", "placeholder", "Car\xE1tula o rol", 1, "form-input", 3, "ngModelChange", "keyup.enter", "ngModel"], ["for", "mc-tipo", 1, "form-label"], ["id", "mc-tipo", 1, "form-select", 3, "ngModelChange", "ngModel"], [3, "ngValue"], [1, "card"], [1, "card-body"], [1, "text-neutral-500", "py-8", "text-center"], [1, "alert-danger"], [1, "py-10", "text-center"], ["for", "mc-corte", 1, "form-label"], ["id", "mc-corte", 1, "form-select", 3, "ngModelChange", "ngModel"], [1, "flex-1"], ["type", "button", 1, "btn-danger", "btn-sm", "shrink-0", 3, "click"], [1, "text-neutral-600", "font-medium"], [1, "text-sm", "text-neutral-500", "mt-1"], [1, "table-wrapper"], [1, "data-table"], [1, "flex", "items-center", "justify-between", "mt-4"], [1, "font-medium", "whitespace-nowrap"], [1, "whitespace-nowrap"], [1, "max-w-[220px]", "truncate", 3, "title"], [1, "max-w-[180px]", "truncate", 3, "title"], [1, "text-sm", "text-neutral-500"], [1, "flex", "gap-2"], ["type", "button", 1, "btn-secondary", "btn-sm", 3, "click", "disabled"]], template: function MovimientosCortesComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div")(2, "h1", 1);
      \u0275\u0275text(3, "Movimientos \xB7 Corte");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "p", 2);
      \u0275\u0275text(5);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(6, "app-filtros-panel", 3);
      \u0275\u0275listener("aplicar", function MovimientosCortesComponent_Template_app_filtros_panel_aplicar_6_listener() {
        return ctx.onFiltrar();
      })("limpiar", function MovimientosCortesComponent_Template_app_filtros_panel_limpiar_6_listener() {
        return ctx.onLimpiarFiltros();
      })("quitar", function MovimientosCortesComponent_Template_app_filtros_panel_quitar_6_listener($event) {
      ...
      \u0275\u0275twoWayListener("ngModelChange", function MovimientosCortesComponent_Template_input_ngModelChange_10_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.filtroBusqueda, $event) || (ctx.filtroBusqueda = $event);
        return $event;
      });
      \u0275\u0275listener("keyup.enter", function MovimientosCortesComponent_Template_input_keyup_enter_10_listener() {
      ...
      \u0275\u0275twoWayListener("ngModelChange", function MovimientosCortesComponent_Template_select_ngModelChange_14_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.filtroTipo, $event) || (ctx.filtroTipo = $event);
        return $event;
      });
      \u0275\u0275repeaterCreate(15, MovimientosCortesComponent_For_16_Template, 2, 2, "option", 8, _forTrack0);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(17, MovimientosCortesComponent_Conditional_17_Template, 8, 2, "div");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(18, "div", 9)(19, "div", 10);
      \u0275\u0275template(20, MovimientosCortesComponent_Conditional_20_Template, 2, 0, "p", 11)(21, MovimientosCortesComponent_Conditional_21_Template, 5, 1, "div", 12)(22, MovimientosCortesComponent_Conditional_22_Template, 5, 0, "div", 13)(23, MovimientosCortesComponent_Conditional_23_Template, 26, 1);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MovimientosCortesComponent, [{
    type: Component,
    args: [{
    ...
    <div class="space-y-6">
      <div>
        <h1 class="text-2xl font-bold text-neutral-800">Movimientos \xB7 Corte</h1>
      ...
      >
        <div>
          <label class="form-label" for="mc-busqueda">B\xFAsqueda</label>
          <input
            id="mc-busqueda"
            type="text"
            class="form-input"
            placeholder="Car\xE1tula o rol"
          ...
          @if (cargando()) {
            ...
            <div class="py-10 text-center">
              ...
              <p class="text-sm text-neutral-500 mt-1">
                Aparecer\xE1n ac\xE1 cuando llegue un reporte de movimientos con las hojas de Corte
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MovimientosCortesComponent, { className: "MovimientosCortesComponent", filePath: "src/app/features/movimientos/movimientos-cortes.component.ts", lineNumber: 167 });
})();
export {
  MovimientosCortesComponent
};
//# sourceMappingURL=chunk-DNDXL3LH.js.map
