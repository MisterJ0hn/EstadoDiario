...
import {
  i as i2,
  t
} from "./chunk-BFTKRJPC.js";
import {
  e,
  l,
  u
} from "./chunk-2B2MM3ZS.js";
import "./chunk-KKZ6NJ4Z.js";
import {
  d,
  o
} from "./chunk-YETX66NL.js";
import {
  __async
} from "./chunk-XWLXMCJQ.js";

// node_modules/@ionic/core/components/p-VWbRkLT7.js
...
var v = (o2, n, r, a, e2, s, d2 = false, c = 0, l3 = true) => __async(null, null, function* () {
  if (!r && !a) return;
  ...
  if (r && Math.abs(f3.scrollAmount) < 4) return D(n), void (s && null !== r && (h(r, y), b(n, r, () => y = 0)));
  if (u2(o2, n, true, f3.inputSafeY, d2), D(n), s && r && (y = f3.scrollPadding, h(r, y)), "undefined" != typeof window) {
    let a2;
    const e3 = () => __async(null, null, function* () {
      void 0 !== a2 && clearTimeout(a2), window.removeEventListener("ionKeyboardDidShow", d3), window.removeEventListener("ionKeyboardDidShow", e3), r && (yield f(r, 0, f3.scrollAmount, f3.scrollDuration)), u2(o2, n, false, f3.inputSafeY), document.activeElement === n && D(n), s && b(n, r, () => y = 0);
    }), d3 = () => {
...
var x = (t2, i3) => __async(null, null, function* () {
  if (void 0 === o) return;
  const l3 = "ios" === i3, f3 = "android" === i3, w2 = t2.getNumber("keyboardHeight", 290), m3 = t2.getBoolean("scrollAssist", true), h2 = t2.getBoolean("hideCaretOnScroll", l3), b2 = t2.getBoolean("inputBlurring", false), y2 = t2.getBoolean("scrollPadding", true), D2 = Array.from(o.querySelectorAll("ion-input, ion-textarea")), x2 = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), M = yield t.getResizeMode(), g = (n) => __async(null, null, function* () {
      ...
      if ("date" !== i4.type && "datetime-local" !== i4.type && (c || l4) && m3 && !K.has(n)) {
        const t4 = ((n2, t5, i5, r, a, e2, s, c2 = false) => {
          ...
          const f4 = void 0 !== d ? d.innerHeight : 0, w3 = (o2) => {
            false !== u3 ? v(n2, t5, i5, r, o2.detail.keyboardHeight, l5, c2, f4, false) : u3 = true;
          }, p2 = () => {
            ...
            t5.hasAttribute(S) ? t5.removeAttribute(S) : (v(n2, t5, i5, r, a, l5, c2, f4), null == d || d.addEventListener("ionKeyboardDidShow", w3), n2.addEventListener("focusout", p2));
          });
...
@ionic/core/components/p-VWbRkLT7.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
*/
//# sourceMappingURL=chunk-MVWDC7I4.js.map
