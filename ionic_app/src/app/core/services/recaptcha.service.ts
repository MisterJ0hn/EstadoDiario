...
export class RecaptchaService {
  ...
  token(accion: AccionRecaptcha): Observable<string | null> {
    // En el APK el WebView corre desde `https://localhost`, un origen que no
    // está registrado en la consola de Google: cargar el script ahí solo
    // agregaría latencia y un error. Ver el apartado del APK en ARCHITECTURE.md.
