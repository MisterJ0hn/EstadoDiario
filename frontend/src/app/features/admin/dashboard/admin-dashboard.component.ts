    ...
    <div class="space-y-6">
      ...
      <div class="flex flex-wrap items-end justify-between gap-4">
        ...
        <div class="flex items-end gap-3">
          ...
          <a routerLink="/admin/clientes" class="btn-primary">Nuevo cliente</a>
        </div>
      </div>
        ...
        <div class="space-y-6 transition-opacity" [class.opacity-60]="cargando()">
              ...
              <div class="flex-1">
                ...
                <ul class="mt-1 space-y-0.5 text-sm">
                  @for (c of d.aprovisionamientos_con_error; track c.id) {
                    <li>
                      <a [routerLink]="['/admin/clientes', c.id]" class="font-medium underline">{{ c.nombre }}</a>
          ...
          <div class="card">
            <div class="card-header flex flex-wrap items-center justify-between gap-2">
              ...
              <a routerLink="/admin/clientes" class="btn-secondary btn-sm">Ver todos los clientes</a>
            </div>
            <div class="card-body">
              @if (d.clientes.length === 0) {
                <div class="py-16 text-center">
                  ...
                  <a routerLink="/admin/clientes" class="btn-primary mt-4">Crear un cliente</a>
                </div>
              } @else {
