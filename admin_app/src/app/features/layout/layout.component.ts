    ...
    <div class="flex flex-col md:flex-row h-screen">
      ...
      >
        <div class="h-16 flex items-center justify-between px-4 border-b border-neutral-700 shrink-0">
          @if (showLabels()) {
            <span class="text-lg font-bold tracking-tight">Administración</span>
          } @else {
            <span class="text-lg font-bold mx-auto">AD</span>
          }
...
export class LayoutComponent {
   ...
   */
  /** Una sola sesión posible acá: el administrador de la plataforma. */
  menu = MENU_PLATAFORMA;

  etiquetaRol = 'Administrador de la plataforma';
}
