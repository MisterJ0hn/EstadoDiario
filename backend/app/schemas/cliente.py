...
Los nombres de los campos siguen el contrato que ya consume el frontend
(`core/models/admin.model.ts`). Donde no calzan con los del modelo se traduce
acá o en el servicio, nunca en el router.
"""
